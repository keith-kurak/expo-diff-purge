...
const RepoUrl = "https://github.com/keith-kurak/expo-diff-purge"
			...
			return [
				...
				...pipe(
					map((idx) => {
						...
						return isBig
							? `[->${toRelease}](${RepoUrl}/compare/release/${fromRelease}..release/${toRelease}) [core](https://github.com/expo/expo/compare/v${fromRelease}...v${toRelease})`
